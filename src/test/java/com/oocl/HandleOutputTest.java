...
public class HandleOutputTest {
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_2H_3D_4S_5C_6D_and_white_8H_9D_TS_JC_QD() {
    //given
    String[] black = {"2H", "3D", "4S", "5C", "6D"};
    String[] white = {"8H", "9D", "TS", "JC", "QD"};
    //when
    PokerHandsGame pokerHandsGame = new PokerHandsGame();
    String result = pokerHandsGame.play(black, white);
    //then
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3D_5S_5C_3D_and_white_4H_4D_6S_6C_4D() {
    //given
    String[] black = {"3H", "3D", "5S", "5C", "3D"};
    String[] white = {"4H", "4D", "6S", "6C", "4D"};
    //when
    PokerHandsGame pokerHandsGame = new PokerHandsGame();
    String result = pokerHandsGame.play(black, white);
    //then
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3D_3S_5C_3D_and_white_4C_4H_4S_8C_4H() {
    //given
    String[] black = {"3H", "3D", "3S", "5C", "3D"};
    String[] white = {"4C", "4H", "4S", "8C", "4H"};
    //when
    PokerHandsGame pokerHandsGame = new PokerHandsGame();
    String result = pokerHandsGame.play(black, white);
    //then
